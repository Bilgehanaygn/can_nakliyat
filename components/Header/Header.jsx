...
const Header = () => {
    ...
    return (
        <div style={{backgroundColor:"#3b3a3e"}}>
            <UpperHeader />
            <div id={headerStyles.header} >
                <div className={headerStyles['desktopheader-wrapper']} >
                    <NavigationButton innerText="ANASAYFA" givenLink="/" enabled={true} activeRoute={router.pathname} />
                    <NavigationButton innerText="HAKKIMIZDA" givenLink="/hakkimizda" enabled={true} activeRoute={router.pathname} />
                    ...
                    <NavigationButton innerText="İLETİŞİM" givenLink="/iletisim" enabled={true} activeRoute={router.pathname} />
                </div>
                <div className={headerStyles['mobileheader-wrapper']} >
                    ...
                    </div>
                    {
                        ...
                        <div style={{position:"absolute", top:90, left:0, zIndex:3, boxSizing:"border-box", width:"100%", height:250, 
                            ...
                            <NavigationButton innerText="ANA SAYFA" givenLink="/" enabled={true} activeRoute={router.pathname} />                    
                            <NavigationButton innerText="HAKKIMIZDA" givenLink="/hakkimizda" enabled={true} activeRoute={router.pathname} />
                            <NavigationButton innerText="GALERİ" givenLink="/galeri" enabled={true} activeRoute={router.pathname} />
                            <NavigationButton innerText="İLETİŞİM" givenLink="/iletisim" enabled={true} activeRoute={router.pathname} />
                            <div style={{marginTop: 20, display:"flex", flexDirection:"row", justifyContent:"space-around", alignItems:"center", width:140}} >
                            <a href={"https://www.instagram.com/cannakliyat1/"} target="_blank" rel="noreferrer" >
                                <div style={{display:"flex", justifyContent:"center", alignItems:"center"}} >
                                    <svg style={{marginRight:5}} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fillRule="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
